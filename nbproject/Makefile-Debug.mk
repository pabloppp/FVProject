...
LDLIBSOPTIONS=-L../../Game_Making/SFML-2.1/lib -lsfml-audio -lsfml-graphics -lsfml-network -lsfml-system -lsfml-window
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../Game_Making/SFML-2.1/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
