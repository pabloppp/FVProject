...
${OBJECTDIR}/hito1/LifeManager.o: hito1/LifeManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/LifeManager.o hito1/LifeManager.cpp
...
${OBJECTDIR}/hito1/genericEnemy.o: hito1/genericEnemy.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/genericEnemy.o hito1/genericEnemy.cpp
