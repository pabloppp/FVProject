...
${OBJECTDIR}/source/lbBehavior.o: source/lbBehavior.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -Ilibs/json-c -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/lbBehavior.o source/lbBehavior.cpp
...
${OBJECTDIR}/source/lnzcohetesBehavior.o: source/lnzcohetesBehavior.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -Ilibs/json-c -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/lnzcohetesBehavior.o source/lnzcohetesBehavior.cpp

${OBJECTDIR}/source/lnzcohetesBullet.o: source/lnzcohetesBullet.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -Ilibs/json-c -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/lnzcohetesBullet.o source/lnzcohetesBullet.cpp
