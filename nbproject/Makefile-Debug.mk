...
${OBJECTDIR}/hito1/BulletScript.o: hito1/BulletScript.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/BulletScript.o hito1/BulletScript.cpp
...
${OBJECTDIR}/hito1/ShotScript.o: hito1/ShotScript.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/ShotScript.o hito1/ShotScript.cpp

${OBJECTDIR}/hito1/bullet.o: hito1/bullet.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/bullet.o hito1/bullet.cpp

${OBJECTDIR}/hito1/enemy.o: hito1/enemy.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/enemy.o hito1/enemy.cpp
...
${OBJECTDIR}/hito1/weapon.o: hito1/weapon.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/weapon.o hito1/weapon.cpp
