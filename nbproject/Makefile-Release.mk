...
${OBJECTDIR}/hito1_old/enemy.o: hito1_old/enemy.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -Ilibs/json-c -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1_old/enemy.o hito1_old/enemy.cpp
...
${OBJECTDIR}/source/GeneralIA.o: source/GeneralIA.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -Ilibs/json-c -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/GeneralIA.o source/GeneralIA.cpp
