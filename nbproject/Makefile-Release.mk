...
${OBJECTDIR}/hito1/Animator.o: hito1/Animator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/Animator.o hito1/Animator.cpp
...
${OBJECTDIR}/hito1/animationTest.o: hito1/animationTest.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/animationTest.o hito1/animationTest.cpp
...
${OBJECTDIR}/hito1/introManager.o: hito1/introManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/introManager.o hito1/introManager.cpp
...
${OBJECTDIR}/hito1/sceneEntregable5.o: hito1/sceneEntregable5.cpp 
	${MKDIR} -p ${OBJECTDIR}/hito1
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibs/SFML-2.1/include -Ilibs/Box2D/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hito1/sceneEntregable5.o hito1/sceneEntregable5.cpp
